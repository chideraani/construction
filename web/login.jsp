<%-- 
    Document   : login
    Created on : 26-Dec-2019, 20:58:47
    Author     : CHIDERA ANI
--%>
  ...
  #social{
    ...
    <body width="1200">
        ...
        <center>
                ...
                <form class="f1" name="LoginForm" action="logverify.jsp" method="POST ">
	...
	<input class="sub" type="submit" value="LOGIN" >
        <p style="font-size:25px;">Not yet registered? <a href="register.jsp" style="color:red;">Register Here</a></p>
                </form>
                </center>
